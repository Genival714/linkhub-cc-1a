...
export const CRONOGRAMA = [
  ...
  { data: "2026-09-17", disc: "fp1", aula: null, tipo: "entrega", titulo: "Registro individual de leitura — “Desaprender é competência” — até 23:59", obs: "No Google Forms anexado na atividade do Classroom. 5 a 8 linhas: uma afirmação bem sustentada e uma frágil, com o porquê. A leitura de cada bloco e os roteiros estão no aviso do Painel." },
  { data: "2026-09-18", disc: "fp1", aula: 7,  tipo: "aula", titulo: "Gerenciamento de conflitos — estratégias construtivas", obs: "A professora avisou que esta aula vai funcionar de um jeito diferente: ver a atividade abaixo." },
  { data: "2026-09-18", disc: "fp1", aula: null, tipo: "atividade", titulo: "Aula-debate “Desaprender é competência” — salas por bloco, plenário e Wayground", obs: "Depende da leitura feita antes. 35 min de discussão na sala do seu bloco, 2 min por bloco no plenário e atividade individual no Wayground no fim. Blocos, roteiros e papéis estão no aviso do Painel." },
